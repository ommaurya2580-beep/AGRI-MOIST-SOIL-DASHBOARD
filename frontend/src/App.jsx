...
import { Leaf, Droplets, Droplet, Settings, Activity, ToggleLeft } from 'lucide-react';
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts';
import './index.css';

// Mock Data for the line chart
const trendData = [
  { date: 'Oct 20', moisture: 35 },
  { date: 'Oct 21', moisture: 55 },
  { date: 'Oct 22', moisture: 51 },
  { date: 'Oct 23', moisture: 62 },
  { date: 'Oct 24', moisture: 70 },
  { date: 'Oct 25', moisture: 59 },
  { date: 'Oct 26', moisture: 68 },
];
...
function App() {
  ...
  const iR = 90;
  const oR = 110;
  const value = 68; // Current moisture
    ...
    <div>
      ...
      <main className="main-content">
        <div className="welcome-text">
          <b>Welcome back, John!</b> | <span>Last Updated: Oct 26, 2023, 10:45 AM</span>
        </div>
        ...
        <div className="dashboard-grid">
          ...
          <div>
            <div className="card" style={{ height: '320px' }}>
              ...
              <div className="gauge-wrapper">
                <div style={{ width: '100%', height: '150px' }}>
                  <ResponsiveContainer>
                    <PieChart>
                      ...
                      {needle(value, gaugeData, cx, cy, iR, oR, '#333')}
                    </PieChart>
                  </ResponsiveContainer>
                </div>
                ...
                <div className="moisture-value">{value}%</div>
                <div className="moisture-status">OPTIMAL</div>
          ...
          <div className="card" style={{ height: '516px' }}>
            <div className="card-header">
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                Moisture Trend - Last 7 Days - Field 1
          ...
          <div className="card" style={{ height: 'fit-content' }}>
            ...
            <div className="pump-status-text">
              Status: Water Pump (Field 1)
            </div>
              ...
              <label className="switch">
                <input 
                  ...
                  onChange={() => {
                    ...
                    if (!isManualOverride) setIsAutoMode(false);
                  }} 
                />
                <span className="slider"></span>
              </label>
            ...
            <div className="override-row">
              ...
              <span className="start-btn">[START PUMP]</span>
            </div>
          </div>
        </div>
      </main>
